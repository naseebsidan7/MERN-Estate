        ...
        <form className="flex flex-col sm:flex-row gap-6">
             ...
             <div className="flex flex-col gap-4 flex-1 ">
                ...
                <div className="flex flex-wrap gap-6">
                     ...
                     <div className=" flex items-center gap-2">
                          <input className="p-3 border border-gray-300 rounded-lg" 
                          type="number" id="discoundPrice" min='1' max='10' required/>
             ...
             <div className="flex flex-col flex-1 gap-4 mt-5 sm:mt-0">
                 ...
                 <button className="bg-slate-700 mt-3 rounded-lg text-white p-3 uppercase hover:opacity-95 disabled:opacity-80">Create Listing</button>
             </div>
