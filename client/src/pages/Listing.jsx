    ...
    <main>
       ...
       {listing && !loadinig && !error && (
             <>
                ...
                {copied && (
                     <p className="fixed top-[23%] right-[5%] z-10 bg-slate-100 rounded-md p-2">
                        Link copied
                     </p>
                )}
                ...
                <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4 ">
                    ...
                    {currentUser && listing?.userRef !== currentUser?._id
                     && !contact
                     && (
                        <button onClick={() => setContact(true)} className="bg-slate-600 text-white rounded-lg uppercase hover:bg-slate-700 p-3">
                                Contact landlord
                        </button>
                    )}
